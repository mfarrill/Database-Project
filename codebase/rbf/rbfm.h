...
******************************************************************************************************************************************************************/
  ...
  static RC getColumnFromTuple(const void *tuple, const vector<Attribute> recordDescriptor, string attrName, void *&value);
  ...
  static bool fieldIsNull(char *nullIndicator, int i);
